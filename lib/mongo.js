...
const USER = process.env.USER //'eperezga'
const PASSWORD = process.env.PASSWORD // 'adminpass'
const DB_NAME = process.env.DB_NAME //'actividadesSaludables' 
const DB_HOST =  process.env.DB_HOST //'cluster0.e77w6tf.mongodb.net'
